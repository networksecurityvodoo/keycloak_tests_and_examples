...
KEYCLOAK_URL=http://10.0.0.1:8080/auth
KEYCLOAK_TARGET_REALM=TestRealm

KEYCLOAK_CLIENT_ID=rest-client
KEYCLOAK_USER_NAME=apiuser
KEYCLOAK_USER_PASSWORD=$(echo PW_BASE64_HERE|base64 -d)   # To Encode Userpassword in Base64 use  echo PASSWORD_HERE | base64
